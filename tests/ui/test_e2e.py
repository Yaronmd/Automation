...
from steps.checkout_steps import fill_checkout_form, continue_checkout
import pytest


@pytest.mark.parametrize("first_name, last_name, postal_code", [
    ("Yaron", "Mordechai", "1234"),
    ("John", "Doe", "5678"),
    ("Jane", "Smith", "9999")
])    
@allure.feature("Test E2E flow")
def test_end_to_end_flow(navigate_and_login, main_page, cart_page, checkout_page,first_name,last_name,postal_code):
